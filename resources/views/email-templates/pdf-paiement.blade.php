...
<head>
    <meta charset="UTF-8">
    <title>Reçu de paiement - {{ $paiement->numero }}</title>
</head>
<body style="font-family: Arial, Helvetica, sans-serif; font-size: 9pt; color: #333; padding: 15px; margin: 0;">
    ...
    <div style="background-color: #f8f9fa; padding: 12px; margin-bottom: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse;" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td style="padding: 4px 10px 4px 0; width: 20%; font-size: 7pt; color: #333; font-family: Arial, Helvetica, sans-serif; text-align: left;">{{ $paiement->membre->nom }} {{ $paiement->membre->prenom }}</td>
                ...
                <td style="padding: 4px 0; width: 30%; font-size: 7pt; color: #333; font-family: Arial, Helvetica, sans-serif; text-align: left;">{{ $paiement->membre->telephone ?? '-' }}</td>
            </tr>
        </table>
    </div>
    ...
    <div style="font-size: 9pt; color: #1e3a5f; margin-bottom: 8px; font-weight: bold; font-family: Arial, Helvetica, sans-serif;">Informations Transaction</div>
    <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;" cellpadding="0" cellspacing="0">
        <tr style="background-color: #f8f9fa;">
            <td style="padding: 6px 8px; width: 40%; color: #666; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">Numéro de paiement :</td>
            <td style="padding: 6px 8px; color: #333; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">{{ $paiement->numero }}</td>
        </tr>
        <tr>
            <td style="padding: 6px 8px; width: 40%; color: #666; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">Date de paiement :</td>
            <td style="padding: 6px 8px; color: #333; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">{{ $paiement->date_paiement->format('d/m/Y') }}</td>
        </tr>
        <tr style="background-color: #f8f9fa;">
            <td style="padding: 6px 8px; width: 40%; color: #666; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">Cotisation :</td>
            <td style="padding: 6px 8px; color: #333; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">{{ $paiement->cotisation->nom ?? 'N/A' }}</td>
        </tr>
        <tr>
            <td style="padding: 6px 8px; width: 40%; color: #666; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">Mode de paiement :</td>
            <td style="padding: 6px 8px; color: #333; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">{{ ucfirst(str_replace('_', ' ', $paiement->mode_paiement ?? '')) }}</td>
        </tr>
        @if($paiement->notes)
            <tr style="background-color: #f8f9fa;">
                <td style="padding: 6px 8px; width: 40%; color: #666; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">Notes :</td>
                <td style="padding: 6px 8px; color: #333; font-size: 8pt; font-family: Arial, Helvetica, sans-serif;">{{ $paiement->notes }}</td>
            </tr>
        @endif
    </table>
    
    <div style="background-color: #e7f3ff; padding: 12px; border-left: 4px solid #1e3a5f; margin-top: 20px;">
        <div style="font-size: 9pt; color: #666; margin-bottom: 5px;">Montant payé :</div>
        <div style="font-size: 15pt; color: #1e3a5f; font-weight: bold;">{{ number_format($paiement->montant, 0, ',', ' ') }} XOF</div>
    </div>
