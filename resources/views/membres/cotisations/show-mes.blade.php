...
#showMesCagnotteTabs .nav-link { font-size: 0.8rem !important; padding: 0.4rem 0.75rem !important; font-weight: 300 !important; font-family: 'Ubuntu', sans-serif !important; }
#showMesCagnotteTabs .nav-link.active { background-color: var(--primary-dark-blue); color: #fff; border-color: var(--primary-dark-blue); }
</style>
...
<ul class="nav nav-tabs mb-3" id="showMesCagnotteTabs" role="tablist">
...
<div class="tab-content" id="showMesCagnotteTabContent">
    ...
    <div class="tab-pane fade" id="paiements" role="tabpanel">
        <div class="card mb-3" style="font-family: 'Ubuntu', sans-serif; font-weight: 300;">
            ...
            <div class="card-body py-2">
                ...
                @if(isset($paiementsCagnotte) && $paiementsCagnotte->count() > 0)
                    ...
                    <div class="table-responsive">
                        <table class="table table-compact-membre table-sm table-hover mb-0" id="table-paiements-cagnotte">
                            <thead>
                                <tr>
                                    <th>Membre</th>
                                    <th>Date</th>
                            ...
                            <tbody>
                                @foreach($paiementsCagnotte as $paiement)
                                    <tr>
