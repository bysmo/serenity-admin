    ...
    public function run(): void
    {
        ...
        $cotisationsPubliques = [
            ...
            [
                ...
                'description' => 'Aide financière ponctuelle aux veuves et aux orphelins des Forces de Défense et de Sécurité (FDS) tombés au combat pour la défense du territoire burkinabè. Chaque contribution compte.',
                'notes'       => 'Versements ponctuels aux familles bénéficiaires identifiées par le comité de gestion.',
                'type'        => 'ponctuelle',
                'frequence'   => 'unique',
                'type_montant'=> 'libre',
                'montant'     => null,
        ...
        $cotisationsPrivees = [
            ...
            [
                'nom'         => 'Célébration des 25 ans du Collège de la Salle de Oauagdougou',
                'description' => 'Collecte communautaire pour financer la construction et l\'équipement d\'une école primaire à Babora. Objectif : offrir un cadre scolaire digne aux enfants du village et réduire le taux d\'abandon scolaire.',
                'notes'       => 'Objectif total : 5 000 000 FCFA. Phase 1 en cours (fondations + murs). Rapport financier mensuel disponible aux clients.',
                'type'        => 'ponctuelle',
                'frequence'   => 'unique',
                'type_montant'=> 'libre',
                'montant'     => null,
            ...
            [
                'nom'         => 'Association des ressortissants de Fada résidents à Ouagadougou - Cotisation mensuelle',
                'description' => 'Cotisation mensuelle des membres de l\'association des ressortissants de Fada résidents à Ouagadougou. Objectif : financer les projets de développement de l\'association.',
            ...
            [
                'nom'         => 'Quêtes dominicales — Paroisse Cathédrale de Ouagadougou',
                'description' => 'Collecte des fidèles de la Paroisse de la Cathédrale de l\'Immaculée Conception de Ouagadougou. Fonds destinés à l\'entretien de l\'édifice, au soutien des activités pastorales et caritatives de la paroisse.',
        ...
        $frequences   = ['journaliere', 'hebdomadaire', 'mensuelle', 'unique'];
