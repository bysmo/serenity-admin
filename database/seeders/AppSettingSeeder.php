...
class AppSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                'cle' => 'entreprise_nom',
                'valeur' => 'Aladin Technologies Solutions (ALTES)',
                'type' => 'string',
            ...
            [
                ...
                'valeur' => 'Burkina Faso, Ouagadougou, Ouaga 2000, Secteur 23, Parcelle 12, Lot 23, Section KL, 14 BV 5326 OUAGA 14 ZAD',
                'type' => 'string',
            ...
            [
                'cle' => 'entreprise_rccm',
                'valeur' => 'BF-OUA-01-2023-B13-11921',
                'type' => 'string',
            ...
            [
                ...
                'valeur' => '18',
                'type' => 'integer',
                'description' => 'Âge de la majorité requis pour l\'inscription (en années)',
                'groupe' => 'general',
            ],
        ];
